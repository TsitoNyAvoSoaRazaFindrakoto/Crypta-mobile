      ...
      <ScrollView showsVerticalScrollIndicator={false} className="pb-8">
        ...
        <View className="px-6 pt-10 pb-8">
          ...
          <Text className="text-lg text-text-secondary mb-8">
            Secure multi-chain wallet with institutional-grade security and
            elegant design
          </Text>

          <TouchableOpacity
            className="bg-brand-500 py-4 rounded-xl items-center active:bg-brand-700 shadow-lg"
            activeOpacity={0.95}
          >
        ...
        {/* Features Grid */}
        <View className="px-1 py-8  bg-surface-secondary">
          ...
          >
            {[
              ...
              <TouchableOpacity
                key={index}
                className="w-64 mb-2 p-6 rounded-2xl bg-surface-primary border border-border-default"
                activeOpacity={0.9}
              >
                <View
        ...
        <View className="px-6 pt-12 pb-16">
          <View className="bg-brand-600 rounded-2xl p-8 shadow-xl">
            <Text className="text-2xl font-bold text-surface-tertiary text-center mb-3">
              Ready to Start?
            </Text>
            <Text className="text-surface-primary/80 text-center text-sm mb-6">
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.9}
            >
              <Text className="text-brand-600 text-lg font-semibold text-center">
                Get Started Free
              </Text>
            </TouchableOpacity>
          </View>
